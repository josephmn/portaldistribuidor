...
{
    public class CMantVentasDuplicadas
    {
        public List<EMantenimiento> MantVentasDuplicadas(SqlConnection con, Int32 post, Int32 id, String ruc, String user)
        {
            List<EMantenimiento> lEMantenimiento = null;
            SqlCommand cmd = new SqlCommand("ASP_MANT_VENTAS_DUPLICADAS", con);
