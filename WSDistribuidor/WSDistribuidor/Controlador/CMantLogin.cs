...
{
    public class CMantLogin
    {
        public List<EMantenimiento> MantLogin(SqlConnection con, Int32 post, Int32 id, String nombres, String apellidos, string foto, Int32 user)
        {
            List<EMantenimiento> lEMantenimiento = null;
            SqlCommand cmd = new SqlCommand("ASP_MANT_LOGIN", con);
            ...
            cmd.Parameters.AddWithValue("@foto", SqlDbType.VarChar).Value = foto;
