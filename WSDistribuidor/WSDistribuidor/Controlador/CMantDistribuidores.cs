...
{
    public class CMantDistribuidores
    {
        public List<EMantenimiento> MantDistribuidores(SqlConnection con, Int32 post, String ruc, String razon, Int32 estado, Int32 user)
        {
            List<EMantenimiento> lEMantenimiento = null;
            SqlCommand cmd = new SqlCommand("ASP_MANT_DISTRIBUIDORES", con);
