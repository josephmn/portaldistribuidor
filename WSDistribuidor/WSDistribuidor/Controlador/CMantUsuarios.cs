...
namespace WSDistribuidor.Controller
{
    ...
    {
        public List<EMantenimiento> MantUsuarios(SqlConnection con, Int32 post, Int32 codigo, String nombres, String apellidos, String correo, String password, Int32 estado, Int32 perfil, Int32 confirmar, Int32 user)
        {
            ...
            cmd.Parameters.AddWithValue("@apellidos", SqlDbType.VarChar).Value = apellidos;
            ...
            cmd.Parameters.AddWithValue("@confirmar", SqlDbType.Int).Value = confirmar;
